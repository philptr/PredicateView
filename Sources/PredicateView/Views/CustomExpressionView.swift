...
public protocol CustomExpressionView<Root, Value, Operator>: BindableView where Value: Hashable {
    associatedtype Root
    ...
    nonisolated static var keyPath: KeyPath<Root, Value> { get }
    ...
    nonisolated static func predicate(for value: Value, operator: Operator) -> Predicate<Root>
    ...
    nonisolated static func decode<PredicateExpressionType: PredicateExpression<Bool>>(
